/**
  ...
  The list of indices could be extended as well. In this example, I assume there will be queries by tournament id. Provider is included into unique index as I
